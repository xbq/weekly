            ...
            [ //表头
                {
                    ...
                    width: 100,
                    title: '任务执行人',
                    templet: '<div>{{d.executorObj.username}}</div>'
                }, {
                    field: 'startTime',
                    width: 120,
                    title: '开始时间',
                    templet: '<div>{{d.startTime.split("T")[0]}}</div>'
                }, {
                    field: 'endTime',
                    width: 120,
                    title: '结束时间',
                    templet: '<div>{{d.endTime.split("T")[0]}}</div>'
                }, {
                    field: 'week',
                    width: 100,
                    title: '第几周'
                    ...
                    width: 200,
                    title: '所属项目',
                    templet: '<div>{{d.projectObj.name}}</div>'
                }, {
                    field: 'process',
                    width: 100,
                    title: '完成状态'
